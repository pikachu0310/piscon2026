...
| E13 | 16:15 | pending | conditionのdrop率を90%から70%へ下げ、3倍のpayloadを永続化する | E12でDB idle 71%、App idle 69%。multi-row済みでwriteはslow 7.8秒、App CPU 9.6% | pending | pending | validかつ77,006超、condition/graph得点が増えれば採用。CPU/timeout増で悪化なら90%へrollback |
