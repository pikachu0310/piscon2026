...
| E9 | 15:45 | pending | GoのDB open/idle connection poolを10/2から64/64へ広げる | E8a fgprofでDB connection取得待ち約6,315秒。MariaDB最大使用14/上限151、全3hostにCPU余力 | pending | pending | connection待ちとtimeoutが減り53,009超なら採用。DB/App CPU飽和やscore低下なら32または10へ戻す |
