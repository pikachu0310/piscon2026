...
| E26 | 17:38 | `3bef94b` | latest専用大域mapを廃止しUUID別history末尾から導出、dropを0にして100%保持 | E25でDB idle 89%、App idle 61%、available約1GiBだがlatest mutex待ち101秒。100%見積もり約249万行 | pending | pending | validatorとmemory/GCを必須確認。Graph/Read増で126,147超なら採用、pressure/score低下なら70%へ戻す |
