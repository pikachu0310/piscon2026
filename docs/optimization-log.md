...
| E16 | 16:34 | pending | Go serviceのsoft/hard NOFILEを524288へ上げ、終盤のaccept失敗を除く | E15 journalで`accept4: too many open files`が連発。systemd表示は524288だがprocess実測はsoft 1024 / hard 524288 | pending | pending | process limit一致、accept error/500/減点0、validかつ85,339超なら採用。起動失敗ならdrop-in rollback |
