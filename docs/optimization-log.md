...
| E2 | 14:12 | pending | conditionのlevel絞り込みとLIMITをSQLへ移し、trend N+1を1 queryへ集約。driverのprepare往復を除く | E1のslow query、CPU、access log | pending | pending | 判定待ち。invalid、減点、またはscore低下なら変更を分割してrollback |
