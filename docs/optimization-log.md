...
| E18 | 16:45 | pending | E17のbatch余力を使いcondition保存率を30%から50%へ上げる | E17でDB/App idle 64%/65%、history INSERT 11.9秒、timeout 133。E13では保存率増が得点へ直結 | pending | pending | 保存行約1.0M、valid/減点0で86,582超を狙う。DB idle枯渇、100ms timeout、score悪化なら30%へrollback |
