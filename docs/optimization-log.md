...
| E3 | 14:38 | pending | condition INSERTをpayload単位のmulti-rowへ変更し、MariaDBのcommit durabilityとbuffer poolを競技向けに調整 | E2aのslow queryとOS | pending | pending | 判定待ち。invalid、減点、score低下ならcode/configを分割してrollback |
