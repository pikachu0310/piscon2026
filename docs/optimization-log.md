...
| E19 | 16:51 | pending | condition保存率を50%から60%へ上げ、30位ボーダー92,604超を狙う | E18は最高89,650、保存107万行、write 18.5秒。DB/Appに約56% idleだが一部condition p95は80〜100ms | pending | pending | valid/減点0かつ89,650超、目標92,604。timeout/tail増が得点増を上回らなければ採用。悪化なら50%へrollback |
