...
| E32r | 18:31 | `35b2e31` | E32と同一binary/configを再測定 | read-firstは値不変で、alloc object 3,558万→2,802万、condition CPU 5.95→5.12秒だがscoreだけ低下 | pending | pending | score回復なら採用。再度大幅低下なら公式scoreを優先してE30へ戻す |
