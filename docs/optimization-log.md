...
| E8a | 15:40 | pending | Nginxのopen-file / worker connection上限を引き上げ、完全3台分離を再評価 | E8のerror logに`socket() failed (24: Too many open files)`が大量発生。systemd NOFILEは524288だがworker_connectionsは1024 | `03d1bf3a-9a7c-4bbf-9e0e-35e62d230727` / s1+s2 `20260719T064046.117587Z-s1-14ee54`; s3 `20260719T064046.106445Z-s3-c343a2` | **53,009 / PASSED**（減点0、timeout 735） | 採用。E7比1.37倍、従来最高E3比1.07倍。次はDB connection pool待ちを解消 |
