...
| E6 | 15:05 | pending | immutable assetsとSPA入口をNginxから直接配信し、upstream接続をkeepalive化 | E5のstatic約5万reqとGo/Nginx CPU飽和 | pending | pending | 判定待ち。E5以下またはrouting不整合ならrollback |
