...
| E31r | 18:19 | `581cd6d` | E31と同一binary/configを再測定 | score低下と、alloc 4.24→2.96GiB・GC scan 3.86→2.59秒・timeout 409→240の改善が矛盾 | pending | pending | validを再確認。score回復ならpool採用、再度大幅低下ならresource効果があってもE30へ戻す |
