...
| E29 | 17:58 | pending | Appの`GOGC`を100から300へ上げ、GC頻度を余剰memoryへ交換 | E28 App host idle 62.2%、平均available 2.15GiB、終了RSS 398MiB。GC scan 2.23秒、mallocgc 4.85秒が残る | pending | pending | App RSS/available、OOM、validator、tailを監視。RSSが約2GiB超、swap/OOM、score悪化なら即100へ戻す |
